...
def plot_accuracy(accuracy_list, k_values):
    ...
    plt.title('KNN Accuracy for Different K Values (Dataset 4)')
    plt.xlabel('K Value')
    plt.ylabel('Accuracy')
    plt.grid(True)
    plt.savefig('./Output/KNN_Accuracy_Dataset4.png')
    plt.show()

# Main Workflow for Dataset 4
print("\nProcessing Dataset 4...")
train_file = './ImputedData/Imputed_TrainData4.xlsx'
label_file = './Excel/output_TrainLabel4.xlsx'
test_file = './ImputedData/Imputed_TestData4.xlsx'
