...
def train_knn_classifier(train_data, train_labels, n_neighbors=4):
...
def predict_and_evaluate(model, train_data, train_labels, test_data):
    ...
    print(f"Dataset 4 - Training Accuracy: {accuracy * 100:.2f}%")
    print("Dataset 4 - Classification Report on Training Data:\n", 
          classification_report(train_labels, train_predictions))
    print("Dataset 4 - Confusion Matrix on Training Data:\n", 
...
train_file = './ImputedData/TrainData4.xlsx'
label_file = './Excel/output_TrainLabel4.xlsx'
test_file = './ImputedData/TestData4.xlsx'
output_file = './Output/Predictions_TestData4_KNN.txt'
...
# Accuracy Summary
print(f"\nDataset 4: Training Accuracy = {accuracy * 100:.2f}%")
