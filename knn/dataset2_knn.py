...
def train_knn_classifier(train_data, train_labels, n_neighbors=3):
...
def predict_and_evaluate(model, train_data, train_labels, test_data):
    ...
    print(f"Dataset 2 - Training Accuracy: {accuracy * 100:.2f}%")
    print("Dataset 2 - Classification Report on Training Data:\n", 
          classification_report(train_labels, train_predictions))
    print("Dataset 2 - Confusion Matrix on Training Data:\n", 
...
train_file = './ImputedData/TrainData2.xlsx'
label_file = './Excel/output_TrainLabel2.xlsx'
test_file = './ImputedData/TestData2.xlsx'
output_file = './Output/Predictions_TestData2_KNN.txt'
...
# Accuracy Summary
print(f"\nDataset 2: Training Accuracy = {accuracy * 100:.2f}%")
