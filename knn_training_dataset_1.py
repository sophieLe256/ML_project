...
def plot_accuracy(accuracy_list, k_values):
    ...
    plt.title('KNN Accuracy for Different K Values (Dataset 1)')
    plt.xlabel('K Value')
    plt.ylabel('Accuracy')
    plt.grid(True)
    plt.savefig('./Output/KNN_Accuracy_Dataset1.png')
    plt.show()

# Main Workflow for Dataset 1
print("\nProcessing Dataset 1...")
train_file = './ImputedData/Imputed_TrainData1.xlsx'
label_file = './Excel/output_TrainLabel1.xlsx'
test_file = './ImputedData/Imputed_TestData1.xlsx'
