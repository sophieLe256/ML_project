...
def plot_accuracy(accuracy_list, k_values):
    ...
    plt.title('KNN Accuracy for Different K Values (Dataset 2)')
    plt.xlabel('K Value')
    plt.ylabel('Accuracy')
    plt.grid(True)
    plt.savefig('./Output/KNN_Accuracy_Dataset2.png')
    plt.show()

# Main Workflow for Dataset 2
print("\nProcessing Dataset 2...")
train_file = './ImputedData/Imputed_TrainData2.xlsx'
label_file = './Excel/output_TrainLabel2.xlsx'
test_file = './ImputedData/Imputed_TestData2.xlsx'
